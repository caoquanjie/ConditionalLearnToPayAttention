...
class ExampleReader(object):
    ...
    def _preprocess(image, bbox_left, bbox_top, bbox_width, bbox_height):
        cropped_left, cropped_top, cropped_width, cropped_height = (int(round((bbox_left - 0.15 * bbox_width))*1.5),
                                                                    int(round(bbox_top - 0.15 * bbox_height)*1.5),
                                                                    int(round(bbox_width * 1.3)*1.5),
                                                                    int(round(bbox_height * 1.3)*1.5))
